...
$content = '
            <form action="insert_user.php" method="post">
			  ...
			  <div class="form-group">
				...
				<input type="text" class="form-control" id="email" name="email" size="24" value="" style="width: auto;">
			  </div>		
			
			  <div class="form-group">
			    <label for="pwd">Password</label>
				<input type="password" class="form-control" id="pwd" name="pwd" size="64" value="" style="width: auto;">
			  </div>		
			
			  <div class="form-group">
			    <label for="first">First Name</label>
				<input type="text" class="form-control" id="first" name="first" size="24" value="" style="width: auto;">
			  </div>		
			
			  <div class="form-group">
			    <label for="last">Last Name</label>
				<input type="text" class="form-control" id="last" name="last" size="24" value="" style="width: auto;">
			  </div>		
			
			  <div class="form-group">
			    <label for="col">College or University</label>
				<input type="text" class="form-control" id="col" name="col" size="24" value="" style="width: auto;">
			  </div>		
			
			  <div class="form-group">
			    <label for="major">Major</label>
				<input type="text" class="form-control" id="major" name="major" size="24" value="" style="width: auto;">
			  </div>		
			  ...
			  <div class="form-group">
				...
				<input type="number" class="form-control" id="cred" name="cred" size="3" value="" style="width: auto;">
			  </div>		
