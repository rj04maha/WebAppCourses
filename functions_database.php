...
----------------------------------------------------------------------- */	
function show_table($table_name, $uid) {
	
	$cols = run_query("SHOW FULL COLUMNS FROM $table_name");
	$rows = run_query("SELECT * FROM $table_name WHERE uid='$uid'");
...
/* -----------------------------------------------------------------------
	 Returns an HTML table from the specified table name
----------------------------------------------------------------------- */	
function show_table_admin($table_name) {
...
/* -----------------------------------------------------------------------
	 Returns an HTML table from the specified table name and semester/year
----------------------------------------------------------------------- */	

function show_table_sem_year($table_name, $uid, $sem_year) {
